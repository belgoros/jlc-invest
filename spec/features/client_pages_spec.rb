...
describe "Client Pages" do
  ...
  describe "index" do
    ...
    it { should have_title(full_title(I18n.t(:list_all, model: Client.model_name.human.pluralize))) }
  ...
  describe "edit" do
    ...
    describe "page" do
      ...
      it { should have_title(full_title(I18n.t(:edit, model: Client.model_name.human))) }
  ...
  describe "client accounts page" do
    ...
    describe "page" do
      ...
      it { should have_title(full_title(client.full_name)) }
      it { should have_link(I18n.t('links.back_to_list'), href: clients_path) }
    end
  ...
  describe "new client page" do
    ...
    describe "with valid information" do
      ...
      it { should have_title(full_title(I18n.t(:new, model: Client.model_name.human))) }
      it { should have_link(I18n.t('links.back_to_list'), href: clients_path) }
