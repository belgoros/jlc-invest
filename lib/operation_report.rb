...
class OperationReport < Prawn::Document  
  ...
  def draw_data_table(operation)    
    ...
    header = draw_table_header(I18n.t('activerecord.models.operation'), I18n.t('activerecord.attributes.operation.sum'), I18n.t('activerecord.attributes.operation.rate'),
    ...
    table(data, :position => x_axe, :width => bounds.right - x_axe - Report::RIGHT_BORDER_SPACE) do
